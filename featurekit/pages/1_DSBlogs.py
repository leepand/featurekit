...
st.set_page_config(page_title="DataScience Blogs", page_icon="📈")

# Load the image and display it
# image = Image.open('pages/rl-games.jpg')
# st.image(image)

# Add a text description
# st.markdown("<p style='text-align: center;'> 博乐强化学习与数据科学.</p>", unsafe_allow_html=True)
...
# Layout Templates
title_temp = """
	<div style="background-color:#f7fbfc;padding:10px;border-radius:10px;margin:10px;">
...
article_temp = """
	...
	"""
head_message_temp = """
	<div style="background-color:#f7fbfc;padding:10px;border-radius:5px;margin:10px;">
	<h4 style="color:white;text-align:center;">{}</h1>
	<img src="https://www.w3schools.com/howto/img_avatar.png" alt="Avatar" style="vertical-align: middle;float:left;width: 50px;height: 50px;border-radius: 50%;">
	<h6>Author:{}</h6> 		
	<h6>Post Date: {}</h6>		
...
def main():
    ...
    html_temp = """
		...
		<h2 style="color:{};text-align:center;">博乐强化学习与数据科学.</h2>
		</div>
		"""
    ...
    if choice == "Home":
        ...
        for i in result:
            ...
            st.write(
                title_temp.format(i[1], i[0], short_article), unsafe_allow_html=True
            )
        ...
        for i in post_result:
            ...
            st.markdown(
                head_message_temp.format(i[1], i[0], i[3]), unsafe_allow_html=True
            )
